...
const Analysis = memo(() => {
  ...
  const chartOptions = {
    ...
    plugins: {
      title: {
        ...
        padding: {
          top: 20, // Add vertical space above the title
          bottom: 30, // Add vertical space between the title and the plot
        },
      },
      legend: {
        display: true,
        position: "left", // Move all labels to the left side
        align: "start", // Align labels to the top of the column
        labels: {
    ...
    layout: {
      padding: {
        ...
        right: 50, // Add more padding to the right
  ...
  return (
    <>
      <h2>
        How are you doing today? What happened? How did that make you feel?
      </h2>
      <section>
      ...
      <Line data={eventsData} options={chartOptions} />
      <section>
        <ul>
