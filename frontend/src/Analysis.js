  ...
  const chartOptions = {
    ...
    plugins: {
      title: {
        ...
        text: "Analysis",
        font: {
          size: 32, // Increase font size to match other headers
          family: "Georgia, Arial, sans-serif", // Match the font family of other headers
      ...
      legend: {
        display: true,
        position: "left", // Move labels to the left of the chart
        align: "start", // Align labels to the top of the left column
        labels: {
